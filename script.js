document.addEventListener('DOMContentLoaded', () => {
  ...
  function initHeroCarousel() {
    // Get featured movies - show newest release dates first
    featuredMovies = movies.filter(movie => movie.featured)
      .slice(0, 5); // First 5 featured movies (newest)

    if (featuredMovies.length === 0) {
      // If no featured movies, use the first 5 newest movies
    ...
    featuredMovies.forEach((movie, index) => {
      ...
      slide.innerHTML = `
                    ...
                    <div class="hero-content">
                        <div class="hero-badge"><i class="fas fa-star"></i> NEW RELEASE</div>
                        <h1 class="hero-title">${movie.title}</h1>
                        <div class="hero-meta">
                            <span><i class="fas fa-calendar-alt"></i> ${movie.releaseDate || movie.year}</span>
  ...
  function startHeroCarousel() {
    ...
    // INCREASED: Set up the carousel to change slides every 7 seconds instead of 5
  ...
  fetch("movies.json")
    ...
    .then(data => {
      ...
      // NEW: Sort movies by releaseDate (newest first)
      movies.sort((a, b) => {
        // Parse release dates for comparison
  ...
  function createSampleData() {
    movies = [
      {
        ...
        releaseDate: "10 April 2025", // NEW FIELD
        year: "2021",
        certification: "PG-13",
        duration: "2h 28m",
        category: "action",
      ...
      },
      {
        id: 2,
        title: "Dune",
        releaseDate: "15 March 2025", // NEW FIELD
        year: "2021",
        certification: "PG-13",
        duration: "2h 35m",
        category: "action",
      ...
      },
      {
        ...
        releaseDate: "22 February 2025", // NEW FIELD
        year: "2021",
        certification: "PG-13",
        duration: "2h 28m",
        category: "action",
      ...
      },
      {
        ...
        releaseDate: "8 February 2025", // NEW FIELD
        year: "2021",
        certification: "R",
        duration: "2h 6m",
        category: "drama",
      ...
      },
      {
        id: 5,
        title: "Don't Look Up",
        releaseDate: "1 February 2025", // NEW FIELD
        year: "2021",
        certification: "R",
        duration: "2h 18m",
        category: "comedy",
    ...
    // NEW: Sort by releaseDate (newest first)
    movies.sort((a, b) => {
      const dateA = new Date(a.releaseDate || a.year);
      const dateB = new Date(b.releaseDate || b.year);
      return dateB - dateA;
  ...
  function renderMovies() {
    // Show newest releases first in all sections
  ...
  function setupEvents() {
    ...
    categoryItems.forEach(item => {
      item.addEventListener('click', () => {
        ...
        else if (cat === "new") filteredMovies = [...movies].sort((a, b) => {
          const dateA = new Date(a.releaseDate || a.year);
          const dateB = new Date(b.releaseDate || b.year);
          return dateB - dateA;
        });
  ...
  function showModal(movie) {
    ...
    // NEW: Display release date if available, otherwise fall back to year
    const releaseInfo = movie.releaseDate ? movie.releaseDate : movie.year;
    detailModal.querySelector('.modal-year').textContent = releaseInfo;
